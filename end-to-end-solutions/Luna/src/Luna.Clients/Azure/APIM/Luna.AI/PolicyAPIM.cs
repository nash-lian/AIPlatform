...
namespace Luna.Clients.Azure.APIM
{
    public class PolicyAPIM : IPolicyAPIM
    {
        ...
        private Models.Azure.Policy RealTimePrediction(APIVersion version)
        {
            ...
            string backendUrl = string.Format(_controllerBaseUrl + "/api/products/{0}/deployments/{1}", version.ProductName, version.DeploymentName);
        ...
        {
            Models.Azure.Policy policy = new Models.Azure.Policy();
            string backendUrl = string.Format(_controllerBaseUrl + "/api/products/{0}/deployments/{1}/subscriptions/@(context.Subscription.Id)", version.ProductName, version.DeploymentName);
            policy.properties.value =
                string.Format(@"<policies>
                    <inbound>
                        <base />
